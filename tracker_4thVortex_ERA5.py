...
pickle.dump([trac_VO,trac_PV,trac_O3],open('Vortex-track_4thVortex_ERA5PV.pkl','wb'))
...
fig.suptitle('Australian 2020 event   4th vortex tracking')
fig.autofmt_xdate()
if figsav:
    plt.savefig(join('figs','VortexMotion_24thVortex_ERA5PV.png'),**figargs)
plt.show()
